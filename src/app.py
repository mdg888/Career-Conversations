...
_question_db: QuestionDB | None = None


def _get_question_db() -> QuestionDB:
    global _question_db
    if _question_db is None:
        _question_db = QuestionDB()
    return _question_db
...
class Me:
    ...
    def handle_tool_calls(self, tool_calls):
        ...
        for tool_call in tool_calls:
            ...
            # Use explicit registry instead of globals() to prevent arbitrary function invocation
